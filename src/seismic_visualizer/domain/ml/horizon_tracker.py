"""HorizonTracker — domain Protocol for ML-based horizon auto-tracking."""
...
@runtime_checkable
class HorizonTracker(Protocol):
    """Contract for an ML model that auto-tracks a horizon in a seismic cube.
    ...
    def track(
        ...
        """Predict horizon voxels starting from seed points.
